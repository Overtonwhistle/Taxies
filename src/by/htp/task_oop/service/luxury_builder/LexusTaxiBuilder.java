...
public class LexusTaxiBuilder extends LuxuryTaxiCarBuilder {
	...
	private final String BRAND_NAME = "LEXUS";
	private final int DEFAULT_YEAR = 2013;
	private final int DEFAULT_SEATS = 4;
	private final int DEFAULT_AIRBAGS = 8;
	private final double DEFAULT_ENGINE_DISPLACEMENT = 3500;
	private final double DEFAULT_MAX_SPEED = 205;
	private final double DEFAULT_FUEL_CONSUMPTION = 13.4;
	private final double DEFAULT_PRICE = 33000;
	private final boolean DEFAULT_TV = false;
	private final boolean DEFAULT_WIFI = true;
	...
	public void buildModel(String model) throws TaxiBuildingException {
		...
		LexusModel opelModel;
		try {
			opelModel = LexusModel.valueOf(model.toUpperCase().trim());
