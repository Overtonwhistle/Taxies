...
public class VWTaxiBuilder extends TaxiCarBuilder {

	private final String BRAND_NAME = "VOLKSWAGEN";
	private final int DEFAULT_YEAR = 2009;
	...
	private final double DEFAULT_MAX_SPEED = 160;
	private final double DEFAULT_FUEL_CONSUMPTION = 7.7;
	private final double DEFAULT_PRICE = 15000;
	...
	public void buildModel(String model) throws TaxiBuildingException {
		...
		VWModel opelModel;
		try {
			opelModel = VWModel.valueOf(model.toUpperCase().trim());

		} catch (IllegalArgumentException e) {
			throw new TaxiBuildingException("Incorrect model!");
		}
		taxiCar.setModel(opelModel.toString());
	}
